...
• Notes to consider:
• Test cases must be altered for original
• methods in model classes aren't consistent in its functioanlity
• some methods exposed but unused in extended classes
